...
<div class="wrapper">
	<section class="flex max-w-[55 rem] justify-between items-center">
		<aside class="">
	...
	<section class= "flex gap-2 text-sm p-2 overflow-x-auto overflow-hidden">
		{#each outputFeatures as feature}
			<p class=" px-1 w-23 bg-slate-100 rounded-sm flex justify-center items-center text-[14px]">{feature.label+": "+feature.dtype}</p>
		{/each}
