<script lang="ts">
    ...
    export let presearch: string;
    import { Search } from 'lucide-svelte';

</script>

<form class="max-w-{width} mx-auto">   
    <label for="default-search" class="mb-2 text-sm font-medium font-dmMono text-gris sr-only">Search</label>
    <div class="relative">
